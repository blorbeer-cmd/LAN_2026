...
|---|---|
| 🏠 **Home** | Die Startseite für jeden Spieler: Live-Status (wer zockt gerade was, via kleinem Agent auf jedem PC – auch mehrere Spiele gleichzeitig, inkl. Vordergrund-Erkennung), manuelles Pausieren („Pause/Essen"), das persönliche Digest („was steht für mich gerade an"), ein Mitteilungs-Feed der letzten Push-Nachrichten mit Direktlink in den passenden Bereich, sowie die Kiosk-Inhalte zum Antippen: laufende Abstimmung, aktives Turnier, offene Essensbestellung, Rangliste-Top-3 und Sitzplan. |
