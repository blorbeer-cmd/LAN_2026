...
- Die Marke ist für alle authentifizierten Mitglieder verfügbar und nur nach Finalisierung
  deaktiviert. Vorwärts gibt es keine Rückfrage; das Aufheben öffnet eine Bestätigung. Das
  Löschen eines eigenen Blocks bestätigt die vollständige Positionsliste und bleibt bei bezahlten
  Positionen deaktiviert.
...
- Mehrere offene Bestellungen starten eingeklappt. Jede Karte nutzt dafür einen Geschwister-
  ...
  eigenen, unabhängigen Expand-Zustand über Live-Renders hinweg.
...
- Die Dialoge entsprechen dem Handover: PayPal-Bestätigung, Rücknahme der Personenmarke,
  Positionslöschung und vollständige Gruppenlöschung.
