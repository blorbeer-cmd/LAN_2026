...
- ESLint-9/10-Konfigurationen für Server und Agent ergänzt.
- Prettier-Konfigurationen und npm-Scripts für Linting und Formatprüfung ergänzt.
- Bestehenden Frontend-Lint-Befund korrigiert.
- Log-Rotation für Docker, systemd und PM2 in `server/OPERATIONS.md` dokumentiert.
