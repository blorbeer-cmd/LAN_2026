# PR #146: Pin project runtime to Node 24
...
- `engines.node >=24` für Server und Agent ergänzt.
- Server-Lockfile synchronisiert.
- README-Schnellstart um die Node-Version ergänzt.
