...
|---|---|
| Core composition and content rules, Regeln 9–11 (292–322) | [Navigation, Rollen und Fachtexte](navigation-and-account-rules.md#navigation-rollen-und-fachtexte) |
...
| Components: Voting, Tournament overview (1321–1399) | [Vote und Turniere](competition-and-game-rules.md#vote-und-turniere) |
...
| Korpus | Wörter |
|---|---:|
| Entfernte normative Quellbereiche | 14.163 |
| Hinzugefügter normativer Regeltext | 14.163 |
| Differenz | 0 |

Nicht im Regeltext gezählt sind 68 Wörter in Zielüberschriften, 84 Wörter in den vier technischen Einleitungen sowie 387 Wörter in diesem README (Einstieg, Links und Migrationsmatrix). Die Zählung wurde vor dem Abschluss mit derselben Methode auf allen 19 Quellbereichen und allen vier Zieldateien ausgeführt.
