...
runMigration({ version: 45, name: 'add Spotify music sessions', up: createMusicSessionTables });
...
runMigration({ version: 46, name: 'move Spotify authorization to local Jam controller', up: migrateMusicToLocalController });
...
runMigration({ version: 47, name: 'close music sessions orphaned by local controller migration', up: closeOrphanedLegacyMusicSessions });
