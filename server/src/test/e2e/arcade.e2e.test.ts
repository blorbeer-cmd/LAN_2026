...
test('Arcade JavaScript and CSS stay lazy, are cached, and support a direct hash route', async () => {
...
test('an obsolete or failed Arcade import cannot replace or damage a Core view', async () => {
