...
export async function loadAll() {
  const [players, games, skills, live, votes, matches, leaderboard, playtime, events] = await Promise.all([
    api.players.list(),
    api.games.list(),
    api.skills.list(),
    api.live.board(),
  ...
  Object.assign(state, { players, games, skills, live, votes, matches, leaderboard, playtime, events });
}
