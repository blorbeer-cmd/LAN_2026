...
const ICONS = {
  ...
  eye: '<path d="M2.06 12.35a1 1 0 0 1 0-.7C3.73 7.6 7.11 5 12 5c4.89 0 8.27 2.6 9.94 6.65a1 1 0 0 1 0 .7C20.27 16.4 16.89 19 12 19c-4.89 0-8.27-2.6-9.94-6.65Z"/><circle cx="12" cy="12" r="3"/>',
  eyeOff: '<path d="m2 2 20 20"/><path d="M6.71 6.71C4.85 7.9 3.44 9.59 2.6 11.65a1 1 0 0 0 0 .7C4.27 16.4 7.65 19 12.54 19c1.63 0 3.08-.29 4.34-.8"/><path d="M10.73 5.08C11.14 5.03 11.56 5 12 5c4.89 0 8.27 2.6 9.94 6.65a1 1 0 0 1 0 .7 12.3 12.3 0 0 1-1.38 2.4"/><path d="M14.12 14.12A3 3 0 0 1 9.88 9.88"/>',
  user: '<circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/>',
  circleUser: '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="10" r="3"/><path d="M7 20.66a8 8 0 0 1 10 0"/>',
  ...
  circleDashed: '<circle cx="12" cy="12" r="9" stroke-dasharray="3.2 3.2"/>',
  ...
  listChecks: '<path d="M16 6H3"/><path d="M16 12H3"/><path d="M10 18H3"/><path d="m15 18 2 2 4-4"/>',
  listX: '<path d="M16 6H3"/><path d="M16 12H3"/><path d="M10 18H3"/><path d="m16 16 4 4"/><path d="m20 16-4 4"/>',
  crown: '<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7Z"/><path d="M5 20h14"/>',
  monitor: '<rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/>',
  laptop: '<path d="M20 16V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v11"/><path d="M2 16h20l-1 3H3l-1-3Z"/>',
...
const FILLED_ICONS = new Set(['paypal']);
...
export function icon(name, { className = '', label = '' } = {}) {
  ...
  return `<svg class="ui-icon${className ? ` ${className}` : ''}" viewBox="0 0 24 24" ${paint} ${aria}>${paths}</svg>`;
}
