...
export function renderProfile(container, ctx) {
  ...
  container.innerHTML = `
    ...
    <div class="grouped-page-sections">
      ...
      <details class="card grouped-page-section collapsible-section" aria-labelledby="profile-password-title">
      ...
      ${trackingEnabled ? `<details class="card grouped-page-section collapsible-section" aria-labelledby="profile-agent-title">
      ...
      <details class="card grouped-page-section collapsible-section" aria-labelledby="profile-push-title">
      ...
      ${monitorsEnabled ? `<details class="card grouped-page-section collapsible-section" aria-labelledby="profile-monitors-title">
